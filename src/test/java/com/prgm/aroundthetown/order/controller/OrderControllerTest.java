        ...
        mockMvc.perform(get("/api/v1/orders/{orderId}", orderRepository.findAll().get(0).getOrderId())
                ...
                .andDo(document("OrderController/find-order",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("data.orderProductDtos.[].productDto.accommodationDto.accommodationName").type(JsonFieldType.STRING).description("숙소명").optional(),
                                fieldWithPath("data.orderProductDtos.[].productDto.accommodationDto.accommodationCategory").type(JsonFieldType.STRING).description("숙소종류").optional(),
                                fieldWithPath("data.orderProductDtos.[].productDto.accommodationDto.accommodationNotice").type(JsonFieldType.STRING).description("안내사항").optional(),
                                fieldWithPath("data.orderProductDtos.[].productDto.accommodationDto.optionNotice").type(JsonFieldType.STRING).description("숙소옵션").optional(),
                                fieldWithPath("data.orderProductDtos.[].productDto.accommodationDto.guide").type(JsonFieldType.STRING).description("숙소가이드").optional(),
                                fieldWithPath("data.orderProductDtos.[].productDto.leisureDto").type(JsonFieldType.OBJECT).description("레저 정보 DTO"),
                                fieldWithPath("data.orderProductDtos.[].productDto.leisureDto.leisureCategory").type(JsonFieldType.STRING).description("레저 카테고리").optional(),
                                fieldWithPath("data.orderProductDtos.[].productDto.leisureDto.leisureInfomation").type(JsonFieldType.STRING).description("레저 정보").optional(),
                                fieldWithPath("data.orderProductDtos.[].productDto.leisureDto.usecase").type(JsonFieldType.STRING).description("usecase").optional(),
                                fieldWithPath("data.orderProductDtos.[].productDto.leisureDto.leisureNotice").type(JsonFieldType.STRING).description("안내사항").optional(),
                                fieldWithPath("data.orderProductDtos.[].productDto.leisureDto.expirationDate").type(JsonFieldType.STRING).description("유효기한").optional(),
                                ...
                                fieldWithPath("data.orderProductDtos.[].productDto.locationDto.howToVisit").type(JsonFieldType.STRING).description("오시는길 정보").optional(),
                                fieldWithPath("data.orderProductDtos.[].productDto.locationDto.latitude").type(JsonFieldType.NUMBER).description("위도").optional(),
                                fieldWithPath("data.orderProductDtos.[].productDto.locationDto.longitude").type(JsonFieldType.NUMBER).description("경도").optional(),
                                fieldWithPath("data.orderProductDtos.[].productDto.locationDto.content").type(JsonFieldType.STRING).description("교통편 상세정보").optional(),
